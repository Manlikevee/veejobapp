    ...
    <div className="searched-jobs">
      ...
      <div className="job-cards">
        ...
        <div className="job-card">
          ...
          <div className="job-card-title" title="UI/UX FRONTEND DEVELOPER">
            UIS / UX Designer
          </div>
          <div className="job-card-subtitle">
            The User Experience Designer position exists to create compelling
        ...
        <div className="job-card">
          ...
          <div className="job-card-title">User Experience Designers</div>
          <div className="job-card-subtitle">
            The User Experience Designer position exists to create compelling
            and digital user experience through excellent design...
          </div>
          ...
          <div className="job-card-buttons">
            <a className="search-buttons card-button" href="indentt2.html">
              {" "}
              Apply Now{" "}
            </a>
            <button className="search-buttons card-buttons-msg">
